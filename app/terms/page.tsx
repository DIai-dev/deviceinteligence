  ...
  return (
    <div className="terms">
      <div className="terms-page">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to DeviceIntelligence AI, 153 Wooster
          ...
          <li>
            <p>
              <strong>Website</strong> refers to DeviceIntelligenceAI.com,
              accessible from{" "}
              <a
                href="DeviceIntelligenceAI.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                DeviceIntelligenceAI.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: info@deviceintelligenceai.com</p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>By phone number: +18433400537</p>
          </li>
        </ul>
      </div>
      <Footer />
